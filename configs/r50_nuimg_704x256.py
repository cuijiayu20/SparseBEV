...
data = dict(
    ...
    train=dict(
        ...
        ann_file=dataset_root + 'nuscenes2d_temporal_infos_train.pkl',
    ...
    val=dict(
        type=dataset_type,
        data_root=dataset_root,
        ann_file=dataset_root + 'nuscenes2d_temporal_infos_val.pkl',
    ...
    test=dict(
        type=dataset_type,
        data_root=dataset_root,
        ann_file=dataset_root + 'nuscenes2d_temporal_infos_test.pkl',
        pipeline=test_pipeline,
        classes=class_names,
        modality=input_modality,
        test_mode=True,
